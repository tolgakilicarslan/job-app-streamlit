        ...
        if st.button("✨ Generate Initial Draft", use_container_width=True, type="primary"):
            if st.session_state.resume_text and st.session_state.job_title and st.session_state.job_description:
                ...
                prompts = {
                    ...
                    "Skill Gap Analysis": f"Act as a career advisor. Analyze my resume against the job description. Identify key skills I am missing and list them in a table. Then, suggest specific online courses, certifications, or projects I could undertake to fill these gaps.\n\n**My Resume:**\n{st.session_state.resume_text}\n\n**Job Title:**\n{st.session_state.job_title}\n\n**Job Description:**\n{st.session_state.job_description}"
                }
